!function(t) {
    ...
    t.exports = (PIXOTRON.lerpDistribution = function(t, e, i) {
        return (e = e || .47) * (1 - t) + (i = i || 7) * t
    }
    ,
    PIXOTRON.uniformDistribution = function() {
        return 1
    }
    ,
    PIXOTRON.cosineDistribution = function(t) {
        const e = t * Math.PI / 2
          , i = Math.cos(e);
        return .47 * (1 - i) + 7 * i
    }
    ,
    PIXOTRON.generateQuasiRandomPoints = function(t, e, i, r) {
        i = i || PIXOTRON.uniformDistribution,
        r = r || PIXOTRON.insideCircle,
        e < 0 && (e = Math.sqrt(t) / t);
        const n = []
          , h = []
          , l = e / Math.sqrt(2)
        ...
        do {
            ...
            u.y = Math.random(),
            d = r(u.x, u.y)
        } while (!d);for (h.push(u),
        n.push(u),
        c.t(u); 0 !== h.length && n.length < t; ) {
            const t = o(h);
            for (let o = 0; o < 30; o++) {
                const o = t.x - .5
                  , s = t.y - .5
...
, function(t, e) {
    t.exports = PIXOTRON.SmoothTransitionAOShader = {
        uniforms: {
    ...
    t.exports = PIXOTRON.SmoothTransitionShadowShader = {
        uniforms: {
    ...
    t.exports = PIXOTRON.SmoothTransitionSoftShadowShadowShader = {
        uniforms: {
            shadowAccumulationBuffer: {
                value: null
            },
...
, function(t, e) {
    ...
    ,
    t.exports = PIXOTRON.createTextureFromRawData = function(t, e) {
    ...
    ,
    t.exports = PIXOTRON.jitterCamera = function(t, e, i, o, s) {
        s = void 0 !== s ? s : .5;
        const a = (2 * e.x - 1) * s
          , r = (2 * e.y - 1) * s;
    ...
    ,
    t.exports = PIXOTRON.insideCircle = function(t, e, i) {
        const o = t - .5
          , s = e - .5;
        return o * o + s * s <= (i = void 0 !== i ? i : .5) * i
    }
    ,
    t.exports = PIXOTRON.insideRectangle = function(t, e, i, o) {
        return i = void 0 !== i ? i : 1,
        o = void 0 !== o ? o : 1,
        t >= 0 && e >= 0 && t <= i && e <= o
    }
    ,
    t.exports = PIXOTRON.blit = function(t, e, i, o) {
        o = void 0 !== o && o,
        PIXOTRON.u.tDiffuse.value = e,
        PIXOTRON.quad.material = PIXOTRON.v,
        t.render(PIXOTRON.R, PIXOTRON.T, i, o)
    }
    ,
    t.exports = PIXOTRON.renderPass = function(t, e, i, o) {
        o = void 0 !== o && o,
        PIXOTRON.quad.material = e,
        t.render(PIXOTRON.R, PIXOTRON.T, i, o)
    }
    ,
    t.exports = PIXOTRON.calculateFOV = function(t, e, i) {
        let o;
        ...
        r.normalize();
        let n = i.dot(r);
        return r.set(-a.x / 2, a.y / 2, a.z / 2),
        r.add(s),
        r.sub(e),
        r.normalize(),
        ...
        r.normalize(),
        n = Math.min(i.dot(r), n),
        2 * (180 * Math.acos(n) / Math.PI)
    }
    ,
    t.exports = PIXOTRON.isPowerOfTwo = function(t) {
        return i(t.width) && i(t.height)
    }
    ,
    t.exports = PIXOTRON.makePowerOfTwo = function(t) {
        function e(t) {
    ...
    ,
    t.exports = PIXOTRON.getDataFromImage = function(t, e) {
        ...
        return a.drawImage(t, 0, 0, o, s),
        a.getImageData(0, 0, o, s)
    }
    ,
    t.exports = PIXOTRON.getPixelFromImageData = function(t, e, i) {
    ...
    ,
    t.exports = PIXOTRON.squareToUniformDiskConcentric = function() {
        const t = new THREE.Vector2;
        return function(e) {
            const i = 2 * e.x - 1
              , o = 2 * e.y - 1;
            let s, a;
            0 === i && 0 === o ? a = s = 0 : i * i > o * o ? (a = i,
            s = Math.PI / 4 * (o / i)) : (a = o,
            s = Math.PI / 2 - i / o * (Math.PI / 4));
            const r = Math.sin(s)
              , n = Math.cos(s);
            return t.x = a * n,
            t.y = a * r,
    ...
    t.exports = PIXOTRON.squareToCosineHemisphere = function() {
        const t = new THREE.Vector3;
        return function(e) {
            const i = PIXOTRON.squareToUniformDiskConcentric(e)
              , o = Math.sqrt(1 - i.x * i.x - i.y * i.y);
            return t.set(i.x, i.y, o),
            t
        }
    }()
}
, function(t, e, i) {
    ...
    i(26),
    i(27),
    t.exports = PIXOTRON.Pixotron = class {
        constructor(t) {
            ...
            this.enableAA = !0,
            this.D = new PIXOTRON.BilateralFilterPass(3,1),
            this.N = new PIXOTRON.GBufferPass(t.gbufferparams);
            const e = t.giParams || {};
            this.enableGI = !!e.enable,
            this.enableGI && this.initializeGI(e),
            this.P = new PIXOTRON.BVHManager;
            const i = void 0 === t.saoparams.accumulative || t.saoparams.accumulative;
            this.O = i ? new PIXOTRON.AccumulativeSAOPass(t.saoparams) : new PIXOTRON.SAOPass(t.saoparams),
            this.M = new PIXOTRON.ShadowPass(t.shadowparams),
            t.groundShadow && (this.C = new PIXOTRON.PlaneShadowBakePass(t.groundShadow)),
            this.S = new PIXOTRON.SuperSampleAAPass,
            this.H = PIXOTRON.generateQuasiRandomPoints(30, -1, PIXOTRON.uniformDistribution, PIXOTRON.insideRectangle);
            const o = {
        ...
        addNodeToAccelerationStructure(t, e) {
            e ? this.P.add(t) : t.traverse(t=>{
                t.isMesh && t.castShadow && (t.updateMatrixWorld(),
                this.P.add(t))
            }
            )
        }
        ...
        blit(t) {
            this.U && PIXOTRON.blit(this.renderer, this.U, t, !1)
        }
        enableVPLGeneration() {
            this.X && (this.X.L = !0)
        }
        ...
        initializeGI(t) {
            this.X = new PIXOTRON.VPLGenerationPass(500),
            this.Z = new PIXOTRON.InstantRadiosityPass
        }
        insertPass(t, e) {
        ...
        render(t, e, i, o) {
            if (this.needsUpdate && (this.G(),
            this.A = 0,
            this.jitterIndex = 0,
            this.needsUpdate = !1,
            this.autoSAOClear = !0,
            this.autoShadowsClear = !0),
            !this.V || this.V.uuid === i.uuid && this.F.uuid === e.uuid || (this.V = i,
            this.F = e,
            this.W.camera = this.V,
            this.W.scene = this.F,
            this.K.V = this.V,
            this.K.J.copy(this.V.projectionMatrix)),
            this.bInitialized || this.Y(t, e, i, o),
            this.q(e),
            this.enableGI && this.X.generateVPLs(e, this.areaLights[0], 10, this.P),
            this.C && this.C.render(this.renderer, e, i),
            this.isSuperSamplingConverged())
                return void this.$();
            this.tt(t, e, i),
            this.et();
            ...
            i.clearViewOffset(),
            this.jitterIndex++,
            this.S.enabled && this.A++
        }
        setSize(t, e) {
            this.renderer && (t *= this.renderer.getPixelRatio(),
        ...
        $() {
            this.renderCompleteCallback && !this.renderCompleteCallbackCalled && (this.renderCompleteCallback(),
        ...
        q(t) {
            ...
            t.traverseVisible(function(t) {
                (t instanceof THREE.DirectionalLight || t instanceof THREE.SpotLight) && t.castShadow && e.punctualLights.push(t),
                t instanceof THREE.RectAreaLight && t.castShadow && (t.shadow = t.shadow ? t.shadow : {},
                e.areaLights.push(t))
            }),
        ...
        ot(t) {
            this.punctualLights.forEach(e=>{
                PIXOTRON.jitterCamera(e.shadow.camera, t, e.shadow.mapSize.x, e.shadow.mapSize.y)
            }
            )
        }
        Y(t, e, i, o) {
            ...
            this.K = new PIXOTRON.TemporalAAPass(i,this.N),
            this.st = new THREE.ShaderPass(THREE.CopyShader),
            this.st.needsSwap = !1,
            this.st.renderToScreen = !o,
            this.j.addPass(this.W),
            THREE.OutlinePass && (this.k = new THREE.OutlinePass(new THREE.Vector2(s.width,s.height),e,i),
            this.j.addPass(this.k)),
            this.B = new PIXOTRON.UnrealBloomPass(this.N,new THREE.Vector2(s.width,s.height),.86,1,.98),
            this.j.addPass(this.B),
            this.j.addPass(this.S),
            this.j.addPass(this.K),
            this.B.enabled = !1,
            this.j.addPass(this.st),
            this.bInitialized = !0;
            ...
            PIXOTRON.renderPass(t, a, this._),
            PIXOTRON.renderPass(t, r, this.I),
            this.punctualLights = [],
            this.areaLights = [],
            this.jitterIndex = 0
        }
        tt(t, e, i) {
            ...
            PIXOTRON.jitterCamera(i, a, o, s),
            this.N.render(t, e, i),
            this.O.render(t, i, this.N, this.D),
            this.M.render(t, e, i),
            this.enableGI && this.Z.render(t, e, i, this.X, this.areaLights[0]),
            i.clearViewOffset(),
            !this.j.renderTarget1.depthTexture && this.N.at && (this.j.renderTarget1.depthTexture = this.N.at,
...
, function(t, e, i) {
    i(5),
    t.exports = PIXOTRON.TextureAreaLightFilter = class {
        constructor(t) {
            this.rt = t,
            PIXOTRON.isPowerOfTwo(this.rt.image) || (this.rt.image = PIXOTRON.makePowerOfTwo(this.rt.image));
            const e = {
                format: THREE.RGBAFormat,
            ...
            const s = PIXOTRON.AreaLightTextureFilterShader;
...
, function(t, e) {
    t.exports = PIXOTRON.AreaLightTextureFilterShader = {
        uniforms: {
            colorTexture: {
                value: null
            },
...
, function(t, e) {
    t.exports = PIXOTRON.BVHManager = class {
        constructor() {
            this.meshes = []
        }
        buildBVHTree(t) {
            ...
            return new class {
                constructor(t, e, o) {
                    ...
                    const s = t.length / 9
                      , a = this.calcExtents(0, s, i);
                    for (this._rootNode = new c(a[0],a[1],0,s,0),
                    this._nodesToSplit = [this._rootNode]; this._nodesToSplit.length > 0; ) {
                ...
                splitNode(t) {
                    if (t.elementCount() <= this._maxTrianglesPerNode || 0 === t.elementCount())
                        return;
                    ...
                    for (let t = e; t < o; t++) {
                        ...
                        for (let e = 0; e < 3; e++)
                            l[e] < r[e] ? s[e].push(t) : a[e].push(t)
                    }
                    const u = [];
                    if (u.length = 3,
                    u[0] = 0 === s[0].length || 0 === a[0].length,
                    u[1] = 0 === s[1].length || 0 === a[1].length,
                    u[2] = 0 === s[2].length || 0 === a[2].length,
                    u[0] && u[1] && u[2])
                        return;
                    const d = [0, 1, 2];
                    let v, m;
                ...
                intersectRay(t, e, i) {
                    ...
                    for (; o.length > 0; ) {
                        const e = o.pop();
                        if (a(t, u, e))
                            for (e._node0 && o.push(e._node0),
                            e._node1 && o.push(e._node1),
                            c = e._startIndex; c < e._endIndex; c++)
                                h.push(this._bboxArray[7 * c])
                    }
                    ...
                    for (c = 0; c < h.length; c++) {
                        ...
                        e && (this.uvs && (f.fromArray(this.uvs, 6 * t),
                        p.fromArray(this.uvs, 6 * t + 2),
                        w.fromArray(this.uvs, 6 * t + 4),
                        r(e, d, v, m, f, p, w, E, T)),
                        n(d, v, m, R),
                        l.push({
                            point: e,
        ...
        add(t) {
            this.meshes[t.uuid] || (this.meshes.push({
                id: t.uuid,
                val: t
            }),
    ...
    function o(t, e, i, o) {
        ...
        return o >= 0 ? (s.min = (t - i) * o,
        s.max = (e - i) * o) : (s.min = (e - i) * o,
        s.max = (t - i) * o),
        s
    }
    const s = function() {
    ...
    function a(t, e, i) {
        ...
        if (s.min > a.max || a.min > s.max)
            return !1;
        (a.min > s.min || s.min != s.min) && (s.min = a.min),
        (a.max < s.max || s.max != s.max) && (s.max = a.max);
        const r = o(i._extentsMin.z, i._extentsMax.z, t.z, e.z);
        return !(s.min > r.max || r.min > s.max) && ((r.min > s.min || s.min != s.min) && (s.min = r.min),
        (r.max < s.max || s.max != s.max) && (s.max = r.max),
        !(s.max < 0))
    }
    function r(t, e, i, o, s, a, r, n, h) {
        return THREE.Triangle.getBarycoord(t, e, i, o, n),
        s.multiplyScalar(n.x),
        a.multiplyScalar(n.y),
        r.multiplyScalar(n.z),
        s.add(a).add(r),
        h.copy(s),
        h
    }
...
, function(t, e, i) {
    i(8),
    t.exports = PIXOTRON.GBufferPass = class {
        constructor(t) {
            t = t || {},
            this.forceDepthAndNormalPass = void 0 === t.forceDepthAndNormalPass || t.forceDepthAndNormalPass,
            this.packingMode = void 0 !== t.packingMode ? t.packingMode : PIXOTRON.GBufferPass.DEPTH_NORMAL_16,
            this.vt = new THREE.MeshNormalMaterial,
            this.ft = new THREE.ShaderMaterial(PIXOTRON.PackingShader_DepthNormal16),
            this.pt = void 0 === t.linearDepth || t.linearDepth,
            this.pt ? (this.wt = new THREE.ShaderMaterial(PIXOTRON.PackingShader_Depth32),
            this.forceDepthAndNormalPass = !0) : (this.wt = new THREE.MeshDepthMaterial,
            this.wt.depthPacking = THREE.RGBADepthPacking)
        }
        dispose() {
        ...
        Y(t) {
            ...
            if (!this.forceDepthAndNormalPass && e && !this.Tt) {
                ...
                this.at || (this.at = new THREE.DepthTexture,
                this.at.type = THREE.UnsignedShortType),
            ...
            if (!e || this.forceDepthAndNormalPass) {
                ...
                this.packingMode === PIXOTRON.GBufferPass.NONE && (this.Rt || (this.Rt = new THREE.WebGLRenderTarget(i,o,t),
                this.Rt.depthTexture = this.at),
                this.Tt || (this.Tt = new THREE.WebGLRenderTarget(i,o,t),
                this.Tt.depthTexture = this.at)),
                this.packingMode === PIXOTRON.GBufferPass.DEPTH_NORMAL_16 && (this.Et || (this.Et = new THREE.WebGLRenderTarget(i,o,t),
                this.Et.depthTexture = this.at))
            }
            this.xt = !0
        }
        Dt(t, e, i) {
            !function(t) {
                t.traverse(function(t) {
                    if (t.isMesh || t.isLineSegments || t.isLine || t.isLineLoop || t.isPoints) {
                        ...
                        (e = (e = t.material && t.material.transparent && !t.material.isShadowMaterial || !!t.castAO) || t.material.alphaTest > 0) && (t.aoVisibility = t.visible,
                        t.visible = !1)
                    }
                })
            }(e);
            const o = t.extensions.get("WEBGL_depth_texture");
            o && !this.forceDepthAndNormalPass && (e.overrideMaterial = this.vt,
            t.render(e, i, this.Tt, !0),
            e.overrideMaterial = null),
            o && !this.forceDepthAndNormalPass || (this.packingMode === PIXOTRON.GBufferPass.NONE && (e.overrideMaterial = this.vt,
            t.render(e, i, this.Tt, !0),
            e.overrideMaterial = null,
            e.overrideMaterial = this.wt,
            this.wt.isMeshDepthMaterial || (this.wt.uniforms.cameraNearFar.value.x = i.near,
            this.wt.uniforms.cameraNearFar.value.y = i.far),
            t.render(e, i, this.Rt, !0),
            e.overrideMaterial = null),
            this.packingMode === PIXOTRON.GBufferPass.DEPTH_NORMAL_16 && (e.overrideMaterial = this.ft,
            this.ft.uniforms.cameraNearFar.value.x = i.near,
            this.ft.uniforms.cameraNearFar.value.y = i.far,
            t.render(e, i, this.Et, !0),
            e.overrideMaterial = null)),
            function(t) {
                t.traverse(function(t) {
                    t.aoVisibility && (t.visible = t.aoVisibility,
                    t.aoVisibility = void 0)
                })
            }(e)
        }
    }
    ,
    PIXOTRON.GBufferPass.NONE = 0,
    PIXOTRON.GBufferPass.DEPTH_NORMAL_16 = 1
}
, function(t, e) {
    t.exports = PIXOTRON.PackingShader_DepthNormal16 = {
        uniforms: {
            cameraNearFar: {
                type: "v2",
    ...
    t.exports = PIXOTRON.PackingShader_Depth32 = {
        uniforms: {
            cameraNearFar: {
                type: "v2",
                value: new THREE.Vector2
...
, function(t, e, i) {
    ...
    i(10),
    i(1),
    t.exports = PIXOTRON.AccumulativeSAOPass = class {
        constructor(t) {
            t = t || {},
            this.intensity = void 0 !== t.intensity ? t.intensity : .25,
            this.occlusionWorldRadius = void 0 !== t.occlusionWorldRadius ? t.occlusionWorldRadius : .8,
            this.smoothTransition = void 0 === t.smoothTransition || t.smoothTransition,
            this.bias = void 0 !== t.bias ? t.bias : .001,
            this.numSamples = void 0 !== t.numSamples ? t.numSamples : 600,
            this.Nt = void 0 !== t.samplesPerFrame ? t.samplesPerFrame : 4,
            this.blurEnabled = !0,
            this.edgeSharpness = 10,
            this.enabled = !0,
            this.needsUpdate = !0,
            this.gt = 0,
            this.Pt(this.numSamples),
            this.Ot = new THREE.ShaderMaterial(PIXOTRON.AccumulativeSAOShader),
            this.Ot.uniforms = THREE.UniformsUtils.clone(this.Ot.uniforms),
            this.Ot.defines.SAMPLES_PER_FRAME = this.Nt,
            this.Mt = new THREE.ShaderMaterial(PIXOTRON.SmoothTransitionAOShader),
            this.A = 0
        }
        convergenceMetric() {
        ...
        dispose() {
            this.St && (this.St.dispose(),
            this.Ht.dispose())
        }
        render(t, e, i, o) {
            if (this.needsUpdate && (this.A = 0,
            this.needsUpdate = !1),
            this.convergenceMetric() >= 1)
                return;
            this.A++,
            this.A = Math.min(this.A, this.Ct - 1),
            this.St || this.Y(t),
            this.Pt(this.numSamples);
            ...
            this.Ot.uniforms.size.value.set(n, h),
            this.yt(e, i);
            const l = this.A % 2 == 0 ? this.Ht : this.St
              , c = this.A % 2 == 0 ? this.St : this.Ht;
            this._t(t, l, c),
            this.blurEnabled && this.convergenceMetric() > 0 && (o.edgeSharpness = this.edgeSharpness,
            o.render(t, c, e, i)),
            this.zt(t, l, c),
            t.autoClear = r,
            t.setClearColor(s),
            t.setClearAlpha(a),
            t.saoBuffer = this.smoothTransition ? l : c
        }
        setSize(t, e) {
            this.Ht && this.Ht.setSize(t, e),
            this.St && this.St.setSize(t, e),
            this.Ot.uniforms.size.value.set(t, e)
        }
        Y(t) {
            ...
            if (!this.St) {
                ...
                this.Ht = new THREE.WebGLRenderTarget(e,i,t)
            }
        }
        _t(t, e, i) {
            this.Ot.uniforms.tAOSumPrevious.value = e,
            PIXOTRON.renderPass(t, this.Ot, i)
        }
        zt(t, e, i) {
            this.smoothTransition && (this.Mt.uniforms.saoAccumulationBuffer.value = i,
            this.Mt.uniforms.transition.value = this.convergenceMetric(),
            PIXOTRON.renderPass(t, this.Mt, e))
        }
        yt(t, e) {
            ...
            let l = e.at ? 0 : 1;
            e.forceDepthAndNormalPass && e.packingMode === PIXOTRON.GBufferPass.DEPTH_NORMAL_16 && (l = 2),
            this.Ot.defines.DEPTH_PACKING_MODE = l,
            this.Ot.defines.DEPTH_NORMAL_TEXTURE = h ? 1 : 0,
            this.Ot.defines.LINEAR_DEPTH = e.pt ? 1 : 0,
            h ? this.Ot.uniforms.tNormalDepth.value = h : (this.Ot.uniforms.tNormal.value = n,
            this.Ot.uniforms.tDepth.value = r),
            this.Ot.uniforms.tQuasiRandomSamples.value = this.It,
            this.Ot.uniforms.numQuasiSamples.value = this.It.image.width
        }
        Pt(t) {
            t !== this.gt && (this.gt = t,
            this.At = PIXOTRON.generateQuasiRandomPoints(t, -1, PIXOTRON.lerpDistribution, PIXOTRON.insideCircle),
            this.It = PIXOTRON.createTextureFromRawData(PIXOTRON.randomizeArray(this.At)),
            this.Ct = this.At.length)
        }
    }
}
, function(t, e) {
    t.exports = PIXOTRON.AccumulativeSAOShader = {
...
, function(t, e, i) {
    i(0),
    i(12),
    t.exports = PIXOTRON.SAOPass = class {
        constructor(t) {
            t = t || {},
            this.intensity = void 0 !== t.intensity ? t.intensity : .25,
            this.occlusionWorldRadius = void 0 !== t.occlusionWorldRadius ? t.occlusionWorldRadius : .8,
            ...
            this.needsUpdate = !0,
            this.Vt = new THREE.ShaderMaterial(PIXOTRON.SAOShader),
            this.Vt.uniforms = THREE.UniformsUtils.clone(this.Vt.uniforms),
            this.Vt.defines = Object.assign({}, this.Vt.defines),
            this.A = 0
        }
        dispose() {
            this.St && (this.St.dispose(),
        ...
        setSize(t, e) {
            this.St && this.St.setSize(t, e),
            this.Vt.uniforms.size.value.set(t, e)
        }
        yt(t, e) {
            const i = 1 / (2 * Math.tan(THREE.Math.DEG2RAD * t.fov / 2))
            ...
            a.x = t.near,
            a.y = t.far,
            this.Vt.uniforms.ProjectionMatrix.value = t.projectionMatrix,
            r = e.at ? e.at : e.Rt ? e.Rt.texture : null;
            const n = e.Tt ? e.Tt.texture : null;
            let h;
            e.Rt || (h = e.Et ? e.Et.texture : null);
            let l = e.at ? 0 : 1;
            e.forceDepthAndNormalPass && e.packingMode === PIXOTRON.GBufferPass.DEPTH_NORMAL_16 && (l = 2),
            this.Vt.defines.DEPTH_PACKING_MODE = l,
            this.Vt.defines.DEPTH_NORMAL_TEXTURE = h ? 1 : 0,
            this.Vt.defines.LINEAR_DEPTH = e.pt ? 1 : 0,
            h ? this.Vt.uniforms.tNormalDepth.value = h : (this.Vt.uniforms.tNormal.value = n,
            this.Vt.uniforms.tDepth.value = r)
        }
        convergenceMetric() {
            return this.A > 1 ? 1 : 0
        }
        render(t, e, i, o) {
            this.needsUpdate && (this.A = 0,
            this.needsUpdate = !1),
            this.convergenceMetric(),
            this.St || this.Y(t);
            const s = t.getDrawingBufferSize().width
              , a = t.getDrawingBufferSize().height;
            this.Vt.uniforms.size.value.set(s, a),
            this.yt(e, i);
            const r = t.getClearColor()
              , n = t.getClearAlpha()
              , h = t.autoClear;
            t.autoClear = !1,
            PIXOTRON.renderPass(t, this.Vt, this.St),
            this.blurEnabled && (o.edgeSharpness = this.edgeSharpness,
            o.render(t, this.St, e, i)),
            t.autoClear = h,
            t.setClearColor(r),
            t.setClearAlpha(n),
            t.saoBuffer = this.St
...
, function(t, e, i) {
    function o(t, e) {
        t.traverse(function(t) {
            if (t.isMesh || t.isLineSegments || t.isLine || t.isLineLoop || t.isPoints) {
                (e ? t.castShadow : t.receiveShadow) || (t.oldVisibility = t.visible,
                t.visible = !1)
            }
        })
    }
    function s(t) {
        t.traverse(function(t) {
            t.oldVisibility && (t.visible = t.oldVisibility,
            t.oldVisibility = void 0)
        })
    }
    i(0),
    i(1),
    i(14),
    t.exports = PIXOTRON.ShadowPass = class {
        constructor(t) {
            t = t || {},
            this.linearDepth = void 0 !== t.linearDepth ? t.linearDepth : 1,
            this.shadowMapResolution = void 0 !== t.shadowMapResolution ? t.shadowMapResolution : 1024,
            this.shadowRadius = void 0 !== t.shadowRadius ? t.shadowRadius : 1,
            this.shadowQuality = void 0 !== t.shadowQuality ? t.shadowQuality : 1,
            this.smoothTransition = void 0 === t.smoothTransition || t.smoothTransition,
            this.shadowBiasMultiplier = void 0 !== t.shadowBiasMultiplier ? t.shadowBiasMultiplier : 1,
            this.numSamples = void 0 !== t.numSamples ? t.numSamples : 100,
            this.side = void 0 !== t.side ? t.side : THREE.FrontSide;
            const e = void 0 !== t.nearPlane ? t.nearPlane : .1
              , i = void 0 !== t.farPlane ? t.farPlane : 10
              , o = void 0 !== t.fov ? t.fov : 110;
            this.Ft = new THREE.PerspectiveCamera(o,1,e,i),
            this.gt = 0,
            ...
            this.lights = [],
            this.enabled = !0,
            this.enableAccumulation = !0,
            this.needsUpdate = !0,
            this.shadowRecieverBBox = null
        }
        convergenceMetric() {
            if (!this.enabled)
                return 1;
        ...
        render(t, e, i) {
            ...
            !this.enableAccumulation && this.A > 0)
                return;
            if (this.convergenceMetric() >= 1)
                return;
            const o = t.getDrawingBufferSize().width
              , s = t.getDrawingBufferSize().height;
            this.Zt || (this.Ft.layers.mask = i.layers.mask,
            this.jt(o, s)),
            this.Ut(this.numSamples);
            ...
            this.lights.forEach(o=>{
                ...
                this.Yt(t, e, i, h, l, o),
                this.smoothTransition && this.A === this.lights.length && PIXOTRON.blit(t, l, this.qt)
            }
            ),
            this.smoothTransition && (this.Mt.uniforms.shadowAccumulationBuffer.value = l,
            this.Mt.uniforms.firstFrameShadowBuffer.value = this.qt,
            this.Mt.uniforms.transition.value = this.convergenceMetric(),
            PIXOTRON.renderPass(t, this.Mt, h)),
            t.autoClear = n,
            t.setClearColor(a),
            t.setClearAlpha(r),
            this.lights.forEach(t=>{
        ...
        setSize(t, e) {
            this.Kt && this.Kt.setSize(t, e),
            this.Jt && this.Jt.setSize(t, e),
            this.Zt && this.Zt.setSize(t, e),
            this.qt && this.qt.setSize(t, e),
            this.$t && this.$t.uniforms.shadowBufferSize.value.set(t, e)
        }
        jt(t, e) {
            const i = {
                format: THREE.RGBAFormat,
            ...
            this.linearDepth ? (this.wt = new THREE.ShaderMaterial(PIXOTRON.PackingShader_Depth32),
            this.wt.uniforms = THREE.UniformsUtils.clone(this.wt.uniforms),
            this.wt.side = this.side) : this.wt = new THREE.MeshDepthMaterial({
                depthPacking: THREE.RGBADepthPacking,
                side: this.side
            }),
            this.$t = new THREE.ShaderMaterial(PIXOTRON.AccumulativeShadowsShader),
            this.$t.uniforms = THREE.UniformsUtils.clone(this.$t.uniforms),
            this.$t.uniforms.shadowBufferSize.value = new THREE.Vector2(t,e),
            ...
            this.Mt = new THREE.ShaderMaterial(PIXOTRON.SmoothTransitionShadowShader),
        ...
        Qt(t, e, i, a) {
            ...
            e.overrideMaterial = this.wt,
            this.linearDepth && (this.wt.uniforms.cameraNearFar.value.x = this.Ft.near,
            this.wt.uniforms.cameraNearFar.value.y = this.Ft.far),
            t.setClearColor(0),
            t.render(e, this.Ft, a, !0),
            e.overrideMaterial = null,
            s(e)
        }
        Gt(t) {
            ...
            e %= this.Wt.length - 1;
            const o = this.Wt[e];
            if (this.bt.x = (o.x - .5) * t.width,
            this.bt.z = 0,
            this.bt.y = (o.y - .5) * t.height,
            this.bt.applyMatrix4(i),
            this.Lt.set(0, 0, 1),
            this.Lt.transformDirection(i),
            this.shadowRecieverBBox) {
                const t = PIXOTRON.calculateFOV(this.shadowRecieverBBox, this.bt, this.Lt);
                this.setFOV(t)
            }
        }
        ...
        Ut(t) {
            t !== this.gt && (this.gt = t,
            this.Wt = PIXOTRON.generateQuasiRandomPoints(t, -1, PIXOTRON.uniformDistribution, PIXOTRON.insideRectangle),
            this.Wt = PIXOTRON.randomizeArray(this.Wt),
            this.Wt.splice(0, 0, new THREE.Vector2(.5,.5)))
        }
    }
}
, function(t, e) {
    t.exports = PIXOTRON.AccumulativeShadowsShader = {
        defines: {
            SHADOW_QUALITY: 1,
            LINEAR_DEPTH: 1
        },
...
, function(t, e, i) {
    ...
    i(16),
    i(17),
    t.exports = PIXOTRON.PlaneShadowBakePass = class {
        constructor(t) {
            t = t || {},
            this.linearDepth = void 0 !== t.linearDepth ? t.linearDepth : 1,
            this.shadowMapResolution = void 0 !== t.shadowMapResolution ? t.shadowMapResolution : 1024,
            ...
            this.smoothTransition = void 0 === t.smoothTransition || t.smoothTransition,
            this.shadowBiasMultiplier = void 0 !== t.shadowBiasMultiplier ? t.shadowBiasMultiplier : 1,
            this.numSamples = void 0 !== t.numSamples ? t.numSamples : 2e3,
            this.numSamplesPerFrame = void 0 !== t.numSamplesPerFrame ? t.numSamplesPerFrame : 2,
            this.darkness = void 0 !== t.darkness ? t.darkness : 1,
            this.falloff = void 0 !== t.falloff ? t.falloff : 2,
            this.size = void 0 !== t.size ? t.size : 1,
            this.onComplete = t.onComplete,
            this.onProgress = t.onProgress,
            this.enable = void 0 === t.enable || t.enable;
            const e = void 0 !== t.nearPlane ? t.nearPlane : .1
              , i = void 0 !== t.farPlane ? t.farPlane : 10;
            ...
            this.kt = new THREE.Matrix4,
            this.needsUpdate = !0,
            this.te = new THREE.Mesh(new THREE.PlaneBufferGeometry(1,1),new THREE.MeshBasicMaterial({
                color: 16777215
            })),
        ...
        render(t, e, i) {
            if (!this.enable)
                return;
            this.ae || this.update(e),
            this.needsUpdate && (this.A = 0,
            this.needsUpdate = !1);
            const o = this.convergenceMetric();
            if (o >= 1)
                return void (this.onComplete && !this.se && (this.onComplete(),
                this.se = !0));
            ...
            for (let o = 0; o < this.numSamplesPerFrame; o++)
                ...
                this.re(),
                this.Qt(t, e, this.bt, this.Zt),
                n = this.A % 2 == 0 ? this.Kt : this.Jt,
                h = this.A % 2 == 0 ? this.Jt : this.Kt,
                this.Yt(t, e, i, n, h);
            ...
            l.x = this.darkness,
            l.y = this.falloff,
            PIXOTRON.renderPass(t, this.Mt, n),
            t.autoClear = r,
            t.setClearColor(s),
            t.setClearAlpha(a),
        ...
        ne(t, e, i) {
            this.he || (this.he = new THREE.ShaderMaterial(PIXOTRON.BlurShader)),
        ...
        jt() {
            ...
            this.Jt.texture.generateMipmaps = !1,
            this.linearDepth ? (this.wt = new THREE.ShaderMaterial(PIXOTRON.PackingShader_Depth32),
            this.wt.uniforms = THREE.UniformsUtils.clone(this.wt.uniforms)) : this.wt = new THREE.MeshDepthMaterial({
                depthPacking: THREE.RGBADepthPacking
            }),
            this.$t = new THREE.ShaderMaterial(PIXOTRON.SoftShadowPlaneShader),
            this.$t.uniforms = THREE.UniformsUtils.clone(this.$t.uniforms),
            ...
            this.$t.defines.SHADOW_QUALITY = this.shadowQuality,
            this.$t.defines.LINEAR_DEPTH = this.linearDepth,
            this.Mt = new THREE.ShaderMaterial(PIXOTRON.SmoothTransitionSoftShadowShadowShader),
            this.Mt.uniforms = THREE.UniformsUtils.clone(this.Mt.uniforms)
        }
        Yt(t, e, i, o, s) {
            this.Ft.matrixWorldInverse.getInverse(this.Ft.matrixWorld),
        ...
        Qt(t, e, i, o) {
            !function(t, e) {
                t.traverse(function(t) {
                    (t.isMesh || t.isLineSegments || t.isLine || t.isLineLoop || t.isPoints) && ((e ? t.castShadow : t.receiveShadow) || (t.oldVisibility = t.visible,
                    t.visible = !1))
                })
            }(e, !0),
            this.Ft.position.copy(i),
        ...
        re() {
            ...
            this.bt.copy(a),
            this.Lt.copy(a),
            this.Lt.multiplyScalar(-1),
            this.Lt.normalize(),
            this.bt.add(this.te.position)
        }
        Ut(t) {
            t !== this.gt && (this.gt = t,
            this.Wt = PIXOTRON.generateQuasiRandomPoints(t, -1, PIXOTRON.uniformDistribution, PIXOTRON.insideCircle),
            this.Wt = PIXOTRON.randomizeArray(this.Wt))
        }
    }
}
, function(t, e) {
    t.exports = PIXOTRON.SoftShadowPlaneShader = {
        defines: {
            SHADOW_QUALITY: 0,
            LINEAR_DEPTH: 1
        },
...
, function(t, e, i) {
    ...
    i(19);
    e.default = PIXOTRON.SuperSampleAAPass = class extends THREE.Pass {
        constructor() {
            super(),
            this.needsSwap = !0,
            this.needsUpdate = !0,
            this.A = 0,
            this.le = new THREE.ShaderMaterial(PIXOTRON.SuperSampleAAShader)
        }
        dispose() {
        ...
        render(t, e, i) {
            ...
            this.ce || this.Y(t),
            this.A++,
            this.le.uniforms.tCurrent.value = i.texture,
            this.le.uniforms.tSumPrevious.value = this.ce.texture,
            this.le.uniforms.accIndex.value = this.A,
            PIXOTRON.renderPass(t, this.le, e),
            PIXOTRON.blit(t, e, this.ce),
            t.autoClear = a,
            t.setClearColor(o, s)
        }
        setSize(t, e) {
...
, function(t, e, i) {
    i(21),
    t.exports = PIXOTRON.TemporalAAPass = class extends THREE.Pass {
        constructor(t, e) {
            super(),
            this.feedBack = new THREE.Vector2(.8,.9),
            this.V = t,
            this.N = e,
            this.ue = new THREE.ShaderMaterial(PIXOTRON.TemporalAAShader),
            this.de = new THREE.Matrix4,
            this.ve = new THREE.Matrix4,
            this.J = new THREE.Matrix4,
            this.J.copy(this.V.projectionMatrix)
        }
        dispose() {
            this.me && this.me.dispose()
        }
        setSize(t, e) {
            this.me && this.me.setSize(t, e),
            this.J.copy(this.V.projectionMatrix)
        }
        render(t, e, i) {
            this.Y(t);
            ...
            t.autoClear = !1,
            t.setClearColor(new THREE.Color(0,0,0), 0),
            this.ve.multiplyMatrices(this.J, this.V.matrixWorldInverse),
            this.fe(t, i),
            PIXOTRON.renderPass(t, this.ue, e),
            PIXOTRON.blit(t, e, this.me),
            t.setClearColor(o, s),
            t.autoClear = a,
            this.de.copy(this.ve)
        }
        Y(t) {
            const e = t.getDrawingBufferSize().width
              , i = t.getDrawingBufferSize().height;
        ...
        fe(t, e) {
            let i, o;
            i = this.N.at ? this.N.at : this.N.Rt ? this.N.Rt.texture : null,
            this.N.Rt || (o = this.N.Et ? this.N.Et.texture : null),
            this.ue.uniforms.currentRT.value = e.texture,
            this.ue.uniforms.previousRT.value = this.me.texture,
            this.ue.uniforms.tDepth.value = i || o;
            let s = this.N.at ? 0 : 1;
            this.N.forceDepthAndNormalPass && this.N.packingMode === PIXOTRON.GBufferPass.DEPTH_NORMAL_16 && (s = 2),
            this.ue.defines.DEPTH_PACKING_MODE = s,
            this.ue.uniforms.currentProjectionViewMatrix.value.copy(this.ve),
            this.ue.uniforms.lastProjectionViewMatrix.value.copy(this.de),
            this.ue.uniforms.ProjectionMatrix.value.copy(this.J),
            this.ue.uniforms.InverseViewMatrix.value.copy(this.V.matrixWorld),
            this.ue.uniforms.feedBack.value.x = this.feedBack.x,
            this.ue.uniforms.feedBack.value.y = this.feedBack.y;
...
, function(t, e) {
    t.exports = PIXOTRON.TemporalAAShader = {
        defines: {
            DEPTH_PACKING_MODE: 1,
            PERSPECTIVE_CAMERA: 1,
            LINEAR_DEPTH: 1,
...
, function(t, e, i) {
    i(23),
    t.exports = PIXOTRON.BilateralFilterPass = class {
        constructor() {
            this.blurKernelSize = 3,
            this.edgeSharpness = 1,
            this.bilateralFilterMaterial = new THREE.ShaderMaterial(PIXOTRON.SAOBilateralFilterShader),
        ...
        setSize(t, e) {
            this.we && this.we.setSize(t, e),
            this.bilateralFilterMaterial.uniforms.size.value.set(t, e)
        }
        dispose() {
            this.we && (this.we.dispose(),
            this.we = null)
        }
        Y(t) {
            if (!this.we) {
        ...
        pe(t, e, i, o) {
            ...
            let n;
            o.Rt || (n = o.Et ? o.Et.texture : null),
            n ? (this.bilateralFilterMaterial.defines.DEPTH_NORMAL_TEXTURE = 1,
            this.bilateralFilterMaterial.uniforms.tNormal.value = n) : this.bilateralFilterMaterial.uniforms.tNormal.value = r,
            this.bilateralFilterMaterial.defines.KERNEL_SAMPLE_RADIUS = this.blurKernelSize,
            this.bilateralFilterMaterial.defines.LINEAR_DEPTH = o.pt ? 1 : 0,
            this.bilateralFilterMaterial.uniforms.tOcclusionDepth.value = e.texture,
            ...
            h.x = i.near,
            h.y = i.far,
            PIXOTRON.renderPass(t, this.bilateralFilterMaterial, this.we),
            this.bilateralFilterMaterial.uniforms.tOcclusionDepth.value = this.we.texture,
            this.bilateralFilterMaterial.uniforms.kernelDirection.value = new THREE.Vector2(0,1),
            PIXOTRON.renderPass(t, this.bilateralFilterMaterial, e)
        }
    }
}
, function(t, e) {
    t.exports = PIXOTRON.SAOBilateralFilterShader = {
        defines: {
            PERSPECTIVE_CAMERA: 1,
...
, function(t, e, i) {
    i(25),
    t.exports = PIXOTRON.UnrealBloomPass = class extends THREE.Pass {
        constructor(t, e, i, o, s) {
            super(),
            this.N = t,
            this.strength = void 0 !== i ? i : 1,
            this.radius = o,
            this.threshold = s,
            ...
            const h = PIXOTRON.BloomExtractShader;
        ...
        render(t, e, i, o, s) {
            ...
            t.autoClear = !1,
            t.setClearColor(new THREE.Color(0,0,0), 0),
            s && t.context.disable(t.context.STENCIL_TEST),
            this.renderToScreen && (this.quad.material = this.basic,
            this.basic.map = i.texture,
            t.render(this.scene, this.camera, void 0, !0)),
            r = this.N.at ? this.N.at : this.N.Rt ? this.N.Rt.texture : null,
            this.N.Rt || (n = this.N.Et ? this.N.Et.texture : null),
            this.materialBloomExtract.uniforms.tDepth.value = r || n;
            let h = this.N.at ? 0 : 1;
            this.N.forceDepthAndNormalPass && this.N.packingMode === PIXOTRON.GBufferPass.DEPTH_NORMAL_16 && (h = 2),
            this.materialBloomExtract.defines.DEPTH_PACKING_MODE = h,
            this.materialBloomExtract.defines.LINEAR_DEPTH = this.N.pt ? 1 : 0,
            this.bloomExtractUniforms.tColor.value = i.texture,
            this.bloomExtractUniforms.bloomThreshold.value = this.threshold,
            this.quad.material = this.materialBloomExtract,
            ...
            for (let e = 0; e < this.nMips; e++)
                ...
                this.separableBlurMaterials[e].uniforms.direction.value = PIXOTRON.UnrealBloomPass.BlurDirectionX,
                ...
                this.separableBlurMaterials[e].uniforms.direction.value = PIXOTRON.UnrealBloomPass.BlurDirectionY,
            ...
            this.renderToScreen ? t.render(this.scene, this.camera, void 0, !1) : t.render(this.scene, this.camera, i, !1),
    ...
    ,
    PIXOTRON.UnrealBloomPass.BlurDirectionX = new THREE.Vector2(1,0),
    PIXOTRON.UnrealBloomPass.BlurDirectionY = new THREE.Vector2(0,1)
}
, function(t, e) {
    t.exports = PIXOTRON.BloomExtractShader = {
        uniforms: {
            tColor: {
                type: "t",
                value: null
...
, function(t, e) {
    t.exports = PIXOTRON.VPLGenerationPass = class {
        constructor(t) {
            this.maxVPL = t,
            this.Ee = 0,
            this.Re = PIXOTRON.generateQuasiRandomPoints(t, -1, PIXOTRON.uniformDistribution, PIXOTRON.insideRectangle),
            this.Te = [];
            for (let t = 0; t < this.Re.length; t++) {
                const e = this.Re[t];
                this.Te.push(new THREE.Vector2(e.x,e.y))
            }
            this.xe = new THREE.Ray,
            this.De = new THREE.Raycaster,
            this.A = 0,
            this.Ne = !1,
            this.ge = [],
            this.Pe = new THREE.SphereBufferGeometry(.05,5,5),
            this.Oe = [],
            this.L = !1,
            this.needsUpdate = !0
        }
        ...
        generateVPLs(t, e, i, o) {
            ...
            if (this.needsUpdate && (this.G(),
            this.needsUpdate = !1),
            this.Ee >= this.getNumVPL())
                return this.needsUpdate = !1,
                void (this.Me.visible = !0);
            this.Me || (this.Me = new THREE.Object3D,
            this.Me.visible = !1,
            t.add(this.Me));
            ...
            for (let s = 0; s < i; s++) {
                const r = this.xe.origin
                  , n = this.xe.direction;
                if (this.De.set(this.xe.origin, this.xe.direction),
                !this.Ce(e, r, n, this.A * i + s))
                    break;
        ...
        Se(t, e, i) {
            ...
            o || (i = i || 32,
            o = PIXOTRON.getDataFromImage(t.image, i),
            this.ge[t.uuid] = o);
            let s = e.x
              , a = e.y;
            void 0 !== t.repeat && (s *= t.repeat.x,
            a *= t.repeat.y),
            s *= o.width,
            a *= o.height,
            t.wrapS === THREE.RepeatWrapping && (s %= o.width),
            t.wrapS === THREE.ClampToEdgeWrapping && (s = Math.min(s, o.width - 1)),
            t.wrapT === THREE.RepeatWrapping && (a %= o.height),
            t.wrapT === THREE.ClampToEdgeWrapping && (a = Math.min(a, o.height - 1));
            const r = Math.floor(s)
              , n = Math.floor(a)
              , h = PIXOTRON.getPixelFromImageData(o, r, n);
            return h.r = Math.pow(h.r / 255, 1),
            h.g = Math.pow(h.g / 255, 1),
            h.b = Math.pow(h.b / 255, 1),
            new THREE.Color(h.r,h.g,h.b)
        }
        Ce(t, e, i, o) {
            if (o < this.Re.length) {
                const s = this.Re[o];
                e.x = (2 * s.x - 1) * t.width * .5,
                e.z = 0,
                e.y = (2 * s.y - 1) * t.height * .5,
                e.applyMatrix4(t.matrixWorld);
                const a = this.Te[o]
                  , r = PIXOTRON.squareToCosineHemisphere(a);
                return i.copy(r),
                i.transformDirection(t.matrixWorld),
                !0
            }
            return !1
        }
...
, function(t, e, i) {
    i(28),
    t.exports = PIXOTRON.InstantRadiosityPass = class {
        constructor() {
            this.ye = 10,
            this._e = 0,
            this.A = 0,
        ...
        render(t, e, i, o, s) {
            ...
            this.Ae || this.Y(t),
            this.A++,
            e.overrideMaterial = this.Ve;
            const n = this.A % 2 == 0 ? this.Ae : this.Fe
              , h = this.A % 2 == 0 ? this.Fe : this.Ae;
            this.Ve.uniforms.accumulationBuffer.value = n.texture,
            this.Ve.uniforms.currentFrameCount.value = this.A,
            this.Ue(r, a, s),
            t.render(e, i, h, !0),
            e.overrideMaterial = null,
            t.indirectDiffuseBuffer = h.texture
        }
        Y(t) {
            ...
            if (!this.ze) {
                ...
                s = i ? THREE.HalfFloatType : s,
                i || (s = e.get("OES_texture_float") ? THREE.FloatType : s)
            }
            const a = {
                type: s,
            ...
            this.Ae = new THREE.WebGLRenderTarget(i,o,a),
            this.Ae.texture.generateMipmaps = !1,
            this.Fe = new THREE.WebGLRenderTarget(i,o,a),
            this.Fe.texture.generateMipmaps = !1,
            this.Ve = new THREE.ShaderMaterial(PIXOTRON.VPLAccumulationShader),
            this.Ve.defines.VPL_COUNT = this.ye,
            this.Ve.uniforms.viewPort.value = new THREE.Vector2(i,o),
            this.Ve.uniforms.currentFrameCount.value = this.A,
            this.Ve.uniforms.minDistance.value = this.minDistance,
            (s === THREE.UnsignedByteType || this.ze) && (this.Ve.dithering = !0)
        }
        G() {
            this.A = 0,
            this._e = 0
...
, function(t, e) {
    t.exports = PIXOTRON.VPLAccumulationShader = {
